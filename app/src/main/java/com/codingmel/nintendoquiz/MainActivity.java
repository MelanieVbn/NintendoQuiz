...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<Question> getEasyQuestions() {
        Question questions[] = new Question[]{
                ...
                new Question("De quel jeu vient cette musique ?", "FACILE", R.drawable.red_mushroom, 0, Arrays.asList("The Legend of Zelda", "Mario Kart", "Splatoon"), "The Legend of Zelda"),
