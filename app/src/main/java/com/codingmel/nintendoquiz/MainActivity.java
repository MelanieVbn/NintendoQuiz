...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<Question> getEasyQuestions() {
        Question questions[] = new Question[]{
                ...
                new Question("De quel jeu vient cette musique ?", "FACILE", R.drawable.red_mushroom, 1, Arrays.asList("The Legend of Zelda", "Mario Kart", "Splatoon"), "The Legend of Zelda"),
                ...
                new Question("Dans quel lieu de Mario Bros retouve-t-on cette musique ?", "FACILE", R.drawable.red_mushroom, 1, Arrays.asList("Les sous terrains", "Sous L'eau", "Dans les airs"), "Les sous terrains"),
                new Question("De quel jeu vient cette musique ?", "FACILE", R.drawable.red_mushroom, 1, Arrays.asList("Wii Sport", "Mario Galaxy", "Pokemon"), "Wii Sport"),
